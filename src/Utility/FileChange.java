...
public class FileChange
{
	...
	public FileChange(String fileName, EditList editList, String pathToGitDir) 
	{
		...
		System.out.println("path to gitdir is: " + pathToGitDir);
		...
		fullPath = pathToGitDir + "\\"  + fileName;
	...
	public ArrayList<String> getModifiedFunctionNames() 
	{
		ArrayList<Function> functions = getModifiedFunctions();
